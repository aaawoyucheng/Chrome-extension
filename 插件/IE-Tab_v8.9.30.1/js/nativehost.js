...
var NativeHost = {
    ...
    */
    ...
    _getFileContent: function(fileName, asBase64, fnResponse) {
    ...
    *        E_UPGRADE_FAILED
    ...
    upgradeHost: function(fnResponse, legacyNPAPIObject) {
        ...
        this._getFileContent(this.HOST_FILE_NAME, true, function(content) {
            var fileContent = content;
            // Get the manifest file content
            this._getFileContent(this.HOST_MANIFEST_FILE_NAME, false, function(content) {
    ...
    */
    ...
    _tryConnectHost: function(hostId, fnResponse) {
        ...
        this.sendMessage({ type: 'PING' }, function(msg) {
            ...
            fnSafeResponse( (msg && (msg.type == 'PONG')) ? 'OK' : 'E_NO_NATIVE_HOST');
        }.bind(this));
    },
